...
# ):
#     """
#     Loss function for note segmentation, written by Xiangming Gu
#     """
#     # truncate the prediction and target
#     sdt_hat, sdt = truncate(sdt_hat, sdt, allowed_len_diff)
#     batch, frame = sdt.shape[:2]

#     sdt_hat = sdt_hat.reshape(batch*frame, 6)       # (BxT, 6)
#     sdt = sdt_hat.reshape(batch*frame, 6)           # (BxT, 6)

#     # post-process sdt/sdt_hat
...
#     sdt_hat = sdt_hat.reshape(batch, frame, 6)
#     sdt = sdt.reshape(batch, frame, 6)
#     sdt4_hat = sdt4_hat.reshape(batch, frame, 3)
#     sdt4 = sdt4.reshape(batch, frame, 3)

#     loss1 = compute_masked_loss(
#         loss,
#         sdt_hat,
#         sdt,
#         sdt_lens,
