...
class FairseqAVHubertFinetune(nn.Module):
    """This lobe enables the integration of fairseq finetuned avhubert models.
    ...
    def __init__(
        ...
        model = model[0].encoder.w2v_model
        self.model = model
        self.freeze = freeze
        self.output_norm = output_norm
    ...
    def extract_features(self, wav):
        ...
        # Extract wav2vec output
        # NOTE: wav has two modalities: audio and video
        # Example: wav = {"video": video_feats, "audio": None}
        out, _ = self.model.extract_finetune(wav, padding_mask=None, mask=False)
...
class FairseqAVHubertPretrain(nn.Module):
    """This lobe enables the integration of fairseq pretrained avhubert models.
